...
const Footer = () => {
  return (
    <div className='gap-5 flex w-full h-screen bg-zinc-900 p-20'>
            <div className='w-1/2 h-full flex flex-col justify-between font-["Founders Grotesk-Semibold"] '>
                <div className='heading'>
                <h1 className='text-[6vw] h-32 font-semibold leading-none uppercase -mb-10'>Eye-</h1>
                <h1 className='text-[6vw] h-64 font-semibold leading-none uppercase -mb-10'>Opening</h1>
                </div>
            ...
            <div className='w-1/2'>
            <div className='w-1/2 h-full font-["Founders Grotesk-Semibold"] '>
                
                <h1 className='text-[6vw] font-semibold leading-none uppercase tracking-tight'>Presentations</h1>
              
                <div className='dets  text-white'>
                  <a  className='block text-xl' href="#">Facbook</a>
                  <a className='block text-xl' href="#">Instagram</a>
                  <a  className='block text-xl'href="#">Twiter</a>
                </div>
            </div>
            </div>
    </div>
