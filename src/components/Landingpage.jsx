    ...
    <div className='w-full h-screen bg-zinc-800 pt-1 '>
                ...
                return (
                 <div className="masker font-['Founders Grotesk-Semibold'] font-extrabold">
                        <div className="w-full flex">
                            {index === 1 && (<div className="mr-[1vw] w-[9vw] h-[5.0vw] rounded-lg relative top-[15px] bg-red-500"></div> )}
                            <h1 key={index} className='text-[6.5vw] leading-[6.5vw] tracking-tighter uppercase font-medium'>{item}</h1>
                        </div>
             </div>
                );
})}
        ...
        <div className="border-t-[1px] bg-zinc-800 mt-36 flex justify-between items-center py-5 px-20 ">
            ...
            <div className="start flex items-center gap-5">
                <div className="px-4 py-2 border-[1px] border-zinc-500 rounded-full font-light text-md uppercase"> Start New Project</div>
